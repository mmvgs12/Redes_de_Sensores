...
-En caso de caida, se produciria un cambio brusco en la aceleración y un cambio repentino en la orientacion.
...
-Tomar medidas periodicamente de la aceleracion y la orientacion. Por ejemplo cada 500 ms mediante un timer (Se puede ajustar para tomar mas o menos medidas)
-Calcular el valor absoluto de la aceleracion.
-Comparar la aceleracion con un registro de los ultimos valores registrados. Por ejemplo 10-15 valores.
